                            ...
                            <div class="card data-tables">
                                <div class="card-body table-striped table-no-bordered table-hover dataTable dtr-inline table-full-width">
                                    <div class="fresh-datatables">
                                        ...
                                        <table id="datatables" class="table table-striped table-responsive table-no-bordered table-hover news" cellspacing="0" width="100%" style="width:100%" data-tblname='news'>
                                            <thead>
                                                <tr>
                                                     <th>#</th>
