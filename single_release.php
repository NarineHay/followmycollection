    ...
    if($colections_count > 0) {
        while ($collections_row = mysqli_fetch_assoc($collections_types_querry)) {
                ...
                <div class="cont_box_second_box">
                    ...
                    <svg data-src="' . $collections_row['image'] . '" class="rel_image" style=" cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal" width="69" height="55" viewBox="0 0 69 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="second_box5"><i class="star_o fa fa-star favorite_release" data-r-id="' . $collections_row['id']  . '"></i></div>
                </div>
                ';
        }
    }else {
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <img src='' alt="relese_image" id="modal_picture" style="height: 100%">
                      </div>
