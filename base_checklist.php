                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card data-tables">
                                <div class="card-body table-striped table-no-bordered table-hover dataTable table-responsive dtr-inline table-full-width">
                                    <div class="toolbar">
                                    ...
                                    <div class="fresh-datatables">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover table-responsive" cellspacing="0" width="100%" style="width:100%" data-tblname='base_checklist'>
                                            <thead>
                                                <tr>
                                                     <th>#</th>
